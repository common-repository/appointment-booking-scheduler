...
$staff_member     = sanitize_text_field( $_REQUEST['staff'] );
$service          = sanitize_text_field( $_REQUEST['service'] );
$booking_st       = sanitize_text_field( $_REQUEST['booking_st'] );
$apt_time_format = sanitize_text_field( $_REQUEST['apt_time_format'] );

$login_email    = sanitize_text_field( isset( $_REQUEST['login_email'] ) ? $_REQUEST['login_email'] : ''  );        /* login */
$login_password = sanitize_text_field( isset( $_REQUEST['login_password'] ) ? $_REQUEST['login_password'] : ''  );    /* login */

$client_email     = sanitize_text_field( $_REQUEST['client_email'] );        /* registeration */
$appoint_username = sanitize_text_field( $_REQUEST['appoint_username'] );
$full_name        = sanitize_text_field( $_REQUEST['full_name'] );
$client_contact   = sanitize_text_field( $_REQUEST['client_contact'] );
$skype_id         = sanitize_text_field( $_REQUEST['skype_id'] );
$apt_date        = sanitize_text_field( $_REQUEST['apt_date'] );
$first_name       = sanitize_text_field( $_REQUEST['first_name'] );
$last_name        = sanitize_text_field( $_REQUEST['last_name'] );
$appoint_notes    = sanitize_text_field( $_REQUEST['appoint_notes'] );
$client_password  = sanitize_text_field( $_REQUEST['client_password'] );
	...
	if ( ! empty( $client ) ) {
		...
		if ( $wp_hasher->CheckPassword( $login_password, $user_password ) ) { ?>
            <script>
                ...
                jQuery.notify("<?php _e( "Login Successfull", WL_ABS_SYSTEM ); ?>", {
                    class: "alert_box",
                    type: "danger",
                    align: "center",
                ...
                document.getElementById('client_username_detail').innerHTML = '<strong><?php _e( "Username :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $client_username;?>';
                document.getElementById('client_fullname_detail').innerHTML = '<strong><?php _e( "Name :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $client_first_name;?><?php echo " " . $client_last_name;?>';
                document.getElementById('client_email_detail').innerHTML = '<strong><?php _e( "Email Id.:", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $client_user_email;?>';

                jQuery('.ap_payment_customer').val('<?php echo $client_first_name;?><?php echo " " . $client_last_name;?>');
                document.getElementById('date_detail').innerHTML = '<strong><?php _e( "Date :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $appt_date_format;?>';
                document.getElementById('time_detail').innerHTML = '<strong><?php _e( "Appointment Time :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $apt_time_format;?>';
                ...
                document.getElementById('client_contact_detail').innerHTML = '<strong><?php _e( "Contact No.:", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $client_contact;?>';
                jQuery('.ap_client_contact_detail').val('<?php echo $client_contact;?>');
                document.getElementById('client_skype_detail').innerHTML = '<strong><?php _e( "Skype Id.:", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $skype_id;?>';
				<?php  } ?>
                ...
                document.getElementById('staff_detail').innerHTML = '<strong><?php _e( "Staff Member :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $staff_name;?>';
                ...
                document.getElementById('service_detail').innerHTML = '<strong><?php _e( "Name :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $service_name;?>';
                document.getElementById('service_price').innerHTML = '<strong><?php _e( "Price :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $service_price;?>';
                ...
                document.getElementById('service_duration').innerHTML = '<strong><?php _e( "Duration :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $service_duration;?><?php echo "minutes";?>';
				<?php
				} else{ ?>
                document.getElementById('service_duration').innerHTML = '<strong><?php _e( "Duration :", WL_ABS_SYSTEM ); ?> &nbsp;</strong>' + '<?php echo $service_duration_with_padding;?><?php echo "minutes";?>';
				<?php
				} ?>
                ...
                jQuery('.ap_payment_amount').val('<?php echo $service_price;?><?php if ( $payment_currency == "" ) {
					echo ' USD';
				} else {
                ...
                jQuery('.service_price_tag').text('<?php echo $service_price;?><?php if ( $payment_currency == "" ) {
					echo ' USD';
				} else {
					echo ' ' . $payment_currency;
				} ?>');
            ...
            <form style="margin-bottom: 0;" action="" method="POST" id="confirm_appointment" name="confirm_appointment">
                ...
                <div id="4" class="ap-steps-detail5">
                    <div class="col-md-6 col-sm-6">
                        <h4 class="ap-heading"><?php _e( "Service Detail", WL_ABS_SYSTEM ); ?></h4>
                    ...
                    <div class="col-md-6 col-sm-6">
                        <h4 class="ap-heading"><?php _e( "User Detail", WL_ABS_SYSTEM ); ?></h4>
                    ...
                    <input type="hidden" class="appoint_unique_id" name="appoint_unique_id"
                    ...
                    <div s class="col-md-12 col-sm-12 confirm-link" id="appt_confirm">
                        <p><strong><?php _e( "Do you want to Confirm Appointment ?", WL_ABS_SYSTEM ); ?></strong></p>
                    </div>
                ...
                <div class="ap-step-link">
					...
					?>
                    <a id="stepback4" href="#step3" onclick="return step4_back();" class="btn step-left"
                       data-toggle="tab"
                       aria-expanded="false"><?php if ( ! empty( $confirm_navigation_text_backward ) ) {
							_e( $confirm_navigation_text_backward, WL_ABS_SYSTEM );
						} else {
							_e( "Back", WL_ABS_SYSTEM );
						} ?></a>
                    <button id="stepnext4" name="stepnext4" href="#step5" type="button" onclick="return step4_next();"
                            class="btn step-right"><?php if ( ! empty( $confirm_navigation_text_forward ) ) {
							_e( $confirm_navigation_text_forward, WL_ABS_SYSTEM );
						} else {
							_e( "Next", WL_ABS_SYSTEM );
						} ?></button>
                </div>
            </form>
			<?php
            ...
            <script>
                jQuery.notify("<?php _e( "Invalid Password", WL_ABS_SYSTEM ); ?>", {
                    class: "alert_box",
                    type: "danger",
                    align: "center",
                    verticalAlign: "middle"
            ...
            <div class="col-md-12 col-sm-12 ap-steps">
                <div class="col-md-2 col-sm-2 ap-step1 services complete">
                    <label><?php _e( "1. Services", WL_ABS_SYSTEM ); ?></label>
                    <span></span>
                </div>
                <div class="col-md-2 col-sm-2 ap-step2 time complete">
                    <label><?php _e( "2. Time", WL_ABS_SYSTEM ); ?></label>
                    <span></span>
                </div>
                <div class="col-md-2 col-sm-2 ap-step3 time active">
                    <label><?php _e( "3. Details", WL_ABS_SYSTEM ); ?></label>
                    <span></span>
                </div>
                <div class="col-md-2 col-sm-2 ap-step4 Details">
                    <label><?php _e( "4. Confirm", WL_ABS_SYSTEM ); ?> </label>
                    <span></span>
                </div>
                <div class="col-md-2 col-sm-2 ap-step6 done">
                    <label><?php _e( "5. Done", WL_ABS_SYSTEM ); ?></label>
                    <span></span>
                </div>
            </div>

            <div class="col-md-12 col-sm-12 step3-form">
				<?php _e( "<center><p>You have entered invalid Password, Please Try Again.</center><br><center>Thank You</center></p>", WL_ABS_SYSTEM ); ?>
            </div>
			...
			<?php } ?>
            <div class="ap-step-link">
                <a id="stepnext2" onclick="return step2_next();" class="btn step-right" data-toggle="tab"
                   aria-expanded="false"><?php _e( "Try Again", WL_ABS_SYSTEM );
					"Try Again"; ?></a>
            </div>
			<?php
		}
        ...
        <script>
            jQuery.notify("<?php _e( "Email Does Not Exist.", WL_ABS_SYSTEM ); ?>", {
                class: "alert_box",
                type: "danger",
                align: "center",
                verticalAlign: "middle"
        ...
        <div class="col-md-12 col-sm-12 step3-form">
			<?php _e( "<center><p>Email Does Not Exist, Please Register Your Account.</center><br><center>Thank You</center></p>", WL_ABS_SYSTEM ); ?>
        </div>
		<?php $detail_editor_content = get_option( "details_tips" );
		if ( ! empty( $detail_editor_content ) ) { ?>
            <div class="row step-description">
        ...
        <div class="ap-step-link">
            <a id="stepnext2" onclick="return step2_next();" class="btn step-right" data-toggle="tab"
               aria-expanded="false"><?php _e( "Try Again", WL_ABS_SYSTEM ); ?></a>
        </div>
		<?php
	}
}
...
if ( isset( $_REQUEST['client_email'] ) ) {
	...
	if ( empty( $user_reg_email ) ) {
        ...
        <script>
            ...
            document.getElementById('service_price').innerHTML = '<strong>Price: &nbsp;</strong>' + '<?php echo $service_price;?><?php if ( $payment_currency == "" ) {
				echo ' USD';
			} else {
				echo ' ' . $payment_currency;
			} ?>';
        ...
        <form style="margin-bottom: 0;" action="" method="POST" id="confirm_appointment" name="confirm_appointment">
            ...
            <div class="ap-step-link">
				...
				$appearence_confirm_navigation_text_forward  = $wpdb->get_col( "SELECT confirm_navigation_text_forward from $appearence_table" );
				$confirm_navigation_text_forward             = $appearence_confirm_navigation_text_forward[0]; ?>
                <a id="stepback4" href="#step3" onclick="return step4_back();" class="btn step-left" data-toggle="tab"
                   aria-expanded="false"><?php if ( ! empty( $confirm_navigation_text_backward ) ) {
						echo $confirm_navigation_text_backward;
					} else {
						echo "Back";
					} ?></a>
                <button id="stepnext4" name="stepnext4" href="#step5" type="button" onclick="return step4_next();"
                        class="btn step-right"><?php if ( ! empty( $confirm_navigation_text_forward ) ) {
						echo $confirm_navigation_text_forward;
					} else {
						echo "Next";
					} ?></button>
            </div>
        ...
        <!-- Step 4 -->
        <script>
            jQuery.notify("<?php _e( "Email Already Registered.", WL_ABS_SYSTEM ); ?>", {
                class: "alert_box",
                type: "danger",
                align: "center",
                verticalAlign: "middle"
        ...
        <div class="col-md-12 col-sm-12 step3-form">
			<?php echo "<center><p>" . __( 'The Email You Entered is already registered with us, Please Login Your Account.', WL_ABS_SYSTEM ) . "</center><br><center>" . __( 'Thank You', WL_ABS_SYSTEM ) . "</center></p>"; ?>
        </div>
		<?php $detail_editor_content = get_option( "details_tips" );
		if ( ! empty( $detail_editor_content ) ) { ?>
            <div class="row step-description">
        ...
        <div class="ap-step-link">
            <a id="stepnext2" onclick="return step2_next();" class="btn step-right" data-toggle="tab"
               aria-expanded="false"><?php echo __( 'Try Again', WL_ABS_SYSTEM ); ?></a>
        </div>
		<?php
	}
}

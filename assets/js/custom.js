...
jQuery(document).ready(function() { //noconflict wrapper 
    jQuery('input#submit_customer_list').addClass('btn theme-customer add-customer');
    jQuery('input#submit_appointment_list').addClass('btn theme-customer add-customer');
});
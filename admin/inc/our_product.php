<?php
	wp_enqueue_style('ap_bootstrap_min_product',WEBLIZAR_A_B_SYSTEM.'/bootstrap/bootstrap.min-product.css' , array() ,true);
	wp_enqueue_style('ap_fontawesome_latest',WEBLIZAR_A_B_SYSTEM.'../assets/font-awesome-latest/css/fontawesome-all.min.css' , array() ,true);
?>
<div class="container col-container p-3">
	<div class="row text-center">
		<div class="col-sm-12 col-md-12">
			<img width="200" src="https://weblizar.com/wp-content/uploads/2016/04/logo.png" />
			<h2><?php _e('Responsive WordPress Premium Themes & Plugins', WL_ABS_SYSTEM); ?></h2>
			<hr>
		</div>
	</div>
	<div class="row p-3">
		<div class="col-sm-12 col-md-12 text-center">
			<a class="" href="" target="_new"><h3><?php _e('Pro Plugins', WL_ABS_SYSTEM); ?></h3></a>
		</div>
	</div>
	<div class="row text-center">
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Facebook Feed', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Pinterest Feed', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Appointment Booking Scheduler', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('SEO Image Optimizer', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Newsletter Subscription Form', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Coming Soon Page', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Recent Related Post', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('About Author', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Gallery Pro', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Ultimate Responsive Image Slider', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Photo Video Link Gallery', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Flickr Album Gallery', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Responsive Portfolio', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Lightbox Slider', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Responsive Photo Gallery', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Clock in Portal', WL_ABS_SYSTEM); ?></h4>
			<p class="icon-size"><i class="far fa-clock"></i></p>
	...
	<div class="row p-3">
		<div class="col-sm-12 col-md-12 text-center">
			<a class="" href="" target="_new"><h3><?php _e('Premium Themes', WL_ABS_SYSTEM); ?></h3></a>
		</div>
	</div>
	<div class="row text-center">
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('RealEstate Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Personal Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Katelyn Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Corporal Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Explora Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Scoreline Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Beautyspa Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Healthcare Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Enigma Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Creative Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Incredible Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Chronicle Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Guardian Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Green Lantern Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Weblizar Premium', WL_ABS_SYSTEM); ?></h4>
		...
		<div class="col products col-sm-6 col-md-4 p-3">
			<h4><?php _e('Love Wedding Premium', WL_ABS_SYSTEM); ?></h4>

...
<div class="panel panel-default">
    <div class="panel-heading"><i class="fa fa-home"></i><span
                class="panel_heading"><?php _e( 'Dashboard', WL_ABS_SYSTEM ) ?></span></div>
    <div class="panel-body" id="dashboard_div">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="span2" onTablet="span4" onDesktop="span2">
                    <div class="circleStatsItemBox green">
                        <div class="header dashboard_appt"><?php _e( 'Approved', WL_ABS_SYSTEM ) ?></div>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="span2" onTablet="span4" onDesktop="span2">
                    <div class="circleStatsItemBox orange">
                        <div class="header dashboard_appt"><?php _e( 'Pending', WL_ABS_SYSTEM ) ?></div>
        ...
        <div class="row ap-services-graph">
            <div class="col-md-12 col-sm-12"><h3
                        style="padding-left: 0px;"><?php _e( 'Overall Report', WL_ABS_SYSTEM ) ?></h3></div>
            ...
            <div class="col-md-4 col-sm-4">
                <div class="span2" onTablet="span4" onDesktop="span2">
                    <div class="circleStatsItemBox purple">
                        ...
                        <div class="circleStat">
							<?php $service_id = $wpdb->get_col( "Select id from $services_table" );
            ...
            <div class="col-md-4 col-sm-4">
                <div class="span2" onTablet="span4" onDesktop="span2">
                    <div class="circleStatsItemBox black">
                        ...
                        <div class="circleStat">
							<?php $appointments = $wpdb->get_col( "Select id from $appointments_table" );
